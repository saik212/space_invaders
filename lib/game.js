...
Game.prototype.drawAll = function(ctx) {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.font = "16px serif";
    ctx.fillStyle = "#f00";
    ctx.fillText("Lives: " + this.ship[0].lives, 10, 50);
    ctx.fillText("Level: " + Game.LEVEL, 30, 80);
  ...
  Game.prototype.startMenu = function (ctx) {
    ctx.clearRect(0,0,Game.DIM_X, Game.DIM_Y);
    ctx.fillStyle = Game.BG_COLOR;
    ctx.fillRect(0,0,Game.DIM_X, Game.DIM_Y);
    ...
    ctx.font = "16px serif";
    ctx.fillStyle = "#f00";
    ctx.fillText("Press Spacebar To Play", Game.DIM_X/2, Game.DIM_Y/2);
  }
